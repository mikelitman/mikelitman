...
> *State capital just bought a seat at the AI table. Read that carefully.* China's state fund took governance of DeepSeek. Commercial investors got none. Capital is neutral. Voting rights are not. @ThePattern — before it's obvious.
> → [The Pattern, No. 144 · 18 July 2026](https://thepattern.media/editions/2026-07-18.html)
<!-- PATTERN:END -->
...
<!-- STAMP:START -->
🤖 *This profile maintains itself. Every morning a GitHub Action pulls the live brief from The Pattern, refreshes each project's numbers, and lists my latest writing, then commits the change. Built and run by an agent. That's the whole point.* · **Last refresh: 19 July 2026**
<!-- STAMP:END -->
